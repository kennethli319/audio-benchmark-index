...
sound-effect-conditioned TTS and fine-grained Foley classification,
...
designed-vocalization timbre transfer, facial-EMG-to-speech synthesis and
silent-speech recognition, synchronized EEG-EMG-audio speech-production
analysis and neural decoding, multimodal ambivalence and hesitancy
recognition,
multimodal spoken-sarcasm and dialogue-pragmatics evaluation,
German read-speech word-boundary timing,
...
evaluation for modern speech deepfake detectors, component-level speech and
environmental-sound deepfake detection, and diffusion-TTS forensics, plus speaker-centric reasoning
...
Last checked: 2026-07-26. Current index size: 343 distinct benchmarks
